...
```bash
curl -X GET "https://upay-sistema-api.onrender.com/api/v1/webhooks/subscriptions" \
...
```bash
curl -X GET "https://upay-sistema-api.onrender.com/api/v1/webhooks/events?page=1&limit=20" \
  -H "Authorization: Bearer SUA_API_KEY"
```
...
```bash
curl -X PUT "https://upay-sistema-api.onrender.com/api/v1/webhooks/subscriptions/{id}" \
  -H "Authorization: Bearer SUA_API_KEY" \
  -H "Content-Type: application/json" \
  -d '{
...
```bash
curl -X DELETE "https://upay-sistema-api.onrender.com/api/v1/webhooks/subscriptions/{id}" \
  -H "Authorization: Bearer SUA_API_KEY"
```
...
```bash
curl -X POST "https://upay-sistema-api.onrender.com/api/v1/webhooks/subscriptions/{id}/test" \
  -H "Authorization: Bearer SUA_API_KEY"
```
