...
```bash
curl -X POST "https://alpa-sistema-api.onrender.com/api/v1/coupons" \
...
```javascript
const response = await fetch('https://alpa-sistema-api.onrender.com/api/v1/coupons', {
  method: 'POST',
  headers: {
...
async function validateCoupon(code, amount) {
  const response = await fetch('https://alpa-sistema-api.onrender.com/api/v1/coupons/validate', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json'
    },
...
```bash
curl -X GET "https://alpa-sistema-api.onrender.com/api/v1/coupons?page=1&limit=20" \
  -H "Authorization: Bearer SUA_API_KEY"
```
...
```bash
curl -X GET "https://alpa-sistema-api.onrender.com/api/v1/coupons/{id}" \
  -H "Authorization: Bearer SUA_API_KEY"
```
...
```bash
curl -X PATCH "https://alpa-sistema-api.onrender.com/api/v1/coupons/{id}" \
  -H "Authorization: Bearer SUA_API_KEY" \
  -H "Content-Type: application/json" \
  -d '{
    "status": "INACTIVE",
...
```bash
curl -X DELETE "https://alpa-sistema-api.onrender.com/api/v1/coupons/{id}" \
  -H "Authorization: Bearer SUA_API_KEY"
```
