...
description: 'Mantenha-se atualizado com as mudanças e histórico de versões da API Alpa'
icon: 'scroll'
---
...
- **Links rastreáveis**: URL de divulgação no formato `https://checkout.alpabr.com/pay/{slug}?aff={codigo}`
...
Os SDKs oficiais da Alpa estão disponíveis para as principais linguagens de backend.
...
A API Alpa está no ar. A partir de hoje você pode integrar pagamentos via PIX, Cartão de Crédito/Débito e Boleto ao seu sistema.
