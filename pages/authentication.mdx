---
title: 'Chaves de API'
description: 'Aprenda como funcionam as chaves de API e como utilizá-las para acessar a Upay'
icon: 'key'
---
...
<Card title="Desenvolvimento x Produção" horizontal>
  Todas as requisições usam o mesmo endpoint `https://upay-sistema-api.onrender.com`.
...
<Steps>
  <Step title="Acesse o Dashboard">
    Faça login em [app.upaybr.com](https://app.upaybr.com) e navegue até **Configurações → Credenciais de API**.
  </Step>
...
```php PHP
$ch = curl_init('https://upay-sistema-api.onrender.com/api/v1/payment-links');
curl_setopt($ch, CURLOPT_HTTPHEADER, [
    'Authorization: Bearer ' . $_ENV['UPAY_API_KEY'],
]);
```
</CodeGroup>
