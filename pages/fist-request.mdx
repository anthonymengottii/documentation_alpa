...
<AccordionGroup>
  <Accordion icon="key" title="Criar conta e obter API Key">
    ...
    1. Acesse o [Dashboard Alpa](https://app.alpabr.com)
  ...
  <Accordion icon="link" title="Criar link de pagamento">
    ...
    **Resposta de sucesso (201 Created):**
    ```json
    {
      ...
      "status": "active",
      "checkoutUrl": "https://checkout.alpabr.com/meu-primeiro-link",
...
<Note>
  **Dúvidas?** Entre em contato com nosso suporte em [suporte@alpa.com.br](mailto:suporte@alpa.com.br) ou consulte a [documentação completa da API](/pages/authentication).
</Note>
