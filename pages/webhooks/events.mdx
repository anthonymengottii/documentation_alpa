...
description: 'Referência completa de todos os eventos de webhook disponíveis na Alpa'
icon: 'bell'
---
...
Todos os eventos seguem a mesma estrutura de envelope. O campo **`type`** identifica o evento:
...
```json
{
  ...
  "data": { },
  "subscription": { "id": "sub_abc123", "url": "https://meusite.com/webhooks/alpa" }
}
```
