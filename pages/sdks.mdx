...
<AccordionGroup>
  ...
  <Accordion title="O que fazer se encontrar um bug em um SDK?">
    Abra uma issue no repositório GitHub do SDK específico. Nossa equipe está sempre atenta para corrigir bugs e melhorar as bibliotecas. Você também pode entrar em contato pelo e-mail <Icon icon="envelope" type="solid" /> suporte@alpabr.com.
  </Accordion>

  <Accordion title="Falta um SDK para a linguagem que eu uso. O que fazer?">
    Entre em contato pelo e-mail <Icon icon="envelope" type="solid" /> suporte@alpabr.com informando qual linguagem você precisa. Nossa equipe avaliará a demanda para incluir na roadmap.
  </Accordion>
</AccordionGroup>
...
<Card title="Precisa de ajuda com a integração?" icon="headset">
  Nossa equipe está disponível para ajudar. Entre em contato: <Icon icon="envelope" type="solid" /> suporte@alpabr.com
</Card>
