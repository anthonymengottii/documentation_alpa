...
1. **Você cria um endpoint no seu sistema**
   Ex.: `https://meusite.com/webhooks/alpa`
    ...
    ```json
    {
      ...
      "data": {
        "transaction": {
          ...
          "method": "PIX",
          "currency": "BRL",
          "receiptUrl": "https://app.alpabr.com/receipt/...",
...
<Card title="Precisa de ajuda?" icon="headset" color="#9747FF">
  Nossa equipe pode te ajudar. Contate-nos: <Icon icon="envelope" type="solid" /> suporte@alpabr.com
</Card>
