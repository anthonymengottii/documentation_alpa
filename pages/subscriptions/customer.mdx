...
```bash
curl --request GET \
  --url 'https://upay-sistema-api.onrender.com/api/subscriptions/customer?email=joao@example.com'
```
...
```bash
curl --request PATCH \
  --url https://upay-sistema-api.onrender.com/api/subscriptions/customer/a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11/cancel \
...
```bash
curl --request PATCH \
  --url https://upay-sistema-api.onrender.com/api/subscriptions/customer/a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11/pause \
  --header 'Content-Type: application/json' \
  --data '{ "email": "joao@example.com" }'
```
...
```bash
curl --request PATCH \
  --url https://upay-sistema-api.onrender.com/api/subscriptions/customer/a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11/resume \
  --header 'Content-Type: application/json' \
  --data '{ "email": "joao@example.com" }'
```
...
```bash
curl --request PATCH \
  --url https://upay-sistema-api.onrender.com/api/subscriptions/customer/a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11/card \
  --header 'Content-Type: application/json' \
  --data '{
