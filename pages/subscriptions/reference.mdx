...
description: 'Visão geral do sistema de assinaturas da Upay — planos, cobranças automáticas e métricas'
icon: 'rotate'
---
...
3. A Upay gera cobranças automáticas no intervalo do plano.
